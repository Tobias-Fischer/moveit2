...
template <typename T>
inline CheckValue<T> IKatan2WithCheck(T fy, T fx, T /* unused */)
{
    CheckValue<T> ret;
    ret.valid = false;
    ret.value = 0;
...
IKFAST_API bool ComputeIk2(const IkReal* eetrans, const IkReal* eerot, const IkReal* pfree, IkSolutionListBase<IkReal>& solutions, void* /* unused */) {
IKSolver solver;
return solver.ComputeIk(eetrans,eerot,pfree,solutions);
}
